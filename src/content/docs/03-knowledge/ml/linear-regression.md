...
description: 线性回归是经典的监督学习回归算法。本笔记推导了线性回归的模型数学原理与矩阵表达形式，并指出了其在最小二乘法下的闭式解析解公式。此外，笔记给出了基于 Python Numpy 库的最小二乘解析解手动实现，以及利用 scikit-learn 框架进行线性回归快速建模的代码模板，为算法学习与应用提供参考。
tags:
  - machine-learning
  - regression
  - math
