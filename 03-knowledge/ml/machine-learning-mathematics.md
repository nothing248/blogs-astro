...
summary: 本笔记系统梳理了面向机器学习的数学基础体系。内容涵盖微积分与极限理论（数列/函数极限与梯度）、初等与特殊函数（双曲及伽马函数）、概率论核心（全概率、贝叶斯与一维/多维概率分布），以及数理统计基础（期望、方差、协方差矩阵、抽样分布、大数定律与中心极限定理），并完整保留了丰富的数学公式与原理图解。
tags:
  - math
  - calculus
  - probability-theory
