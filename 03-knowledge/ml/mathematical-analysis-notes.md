...
summary: 陈传璋《数学分析》（第二版）的知识体系整理。内容涵盖集合与区间、初等函数分类、函数与数列的极限性质与夹逼准则，详细梳理了导数与微分中值定理（费马、罗尔、拉格朗日、柯西、泰勒）、不定积分与定积分计算法（换元、分部、牛顿-莱布尼茨公式）以及一阶可分离微分方程。旨在为数学和机器学习研究提供坚实的微积分理论支撑。
tags:
  - 数学分析
  - 微积分
  - 函数极限
